...
export default function WordGame({ language, onResult }: GameProps) {
  return (
    <div className="mx-auto flex max-w-lg flex-col items-center gap-6 text-center">
      ...
      <h1 className="text-4xl font-extrabold text-[#2c2416]">Words</h1>
      ...
      <div className="grid w-full grid-cols-2 gap-3">
        <button
          ...
          onClick={() => onResult({ correct: true, promptId: "stub-word" })}
        >
          Right
        </button>
        <button
          ...
          onClick={() => onResult({ correct: false, promptId: "stub-word" })}
        >
          Not yet
        </button>
      </div>
